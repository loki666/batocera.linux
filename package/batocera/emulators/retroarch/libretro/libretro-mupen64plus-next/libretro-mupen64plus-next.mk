...
LIBRETRO_MUPEN64PLUS_NEXT_PLATFORM = unix armv neon hardfloat
LIBRETRO_MUPEN64PLUS_NEXT_EXTRA_ARGS += CPUFLAGS="-march=armv8-a+crc -mfloat-abi=hard -mfpu=neon-fp-armv8 -mtune=cortex-a53"
