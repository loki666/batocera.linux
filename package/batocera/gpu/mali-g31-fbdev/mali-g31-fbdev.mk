...
define MALI_G31_FBDEV_INSTALL_STAGING_CMDS
	...
	cp -rf $(@D)/fbdev/mali-g31/aarch64-linux-gnu-7.4.1/lib64/libmali.so.0.20.0 $(STAGING_DIR)/usr/lib/

	(cd $(STAGING_DIR)/usr/lib && ln -sf libmali.so.0.20.0 libmali.so)
	(cd $(STAGING_DIR)/usr/lib && ln -sf libmali.so.0.20.0 libmali.so.0)
	(cd $(STAGING_DIR)/usr/lib && ln -sf libmali.so.0.20.0 libEGL.so)
	(cd $(STAGING_DIR)/usr/lib && ln -sf libmali.so.0.20.0 libEGL.so.1)
	(cd $(STAGING_DIR)/usr/lib && ln -sf libmali.so.0.20.0 libGLESv1_CM.so)
	(cd $(STAGING_DIR)/usr/lib && ln -sf libmali.so.0.20.0 libGLESv1_CM.so.1)
	(cd $(STAGING_DIR)/usr/lib && ln -sf libmali.so.0.20.0 libGLESv2.so)
	(cd $(STAGING_DIR)/usr/lib && ln -sf libmali.so.0.20.0 libGLESv2.so.2)
