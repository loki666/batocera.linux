...
define BATOCERA_TRIGGERHAPPY_INSTALL_RG35XX_PLUS_CONFIG
    cp -v $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/core/batocera-triggerhappy/conf/rg35xx_plus/*.conf      $(TARGET_DIR)/etc/triggerhappy/triggers.d/
endef
...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_RG35XX_PLUS),y)
	BATOCERA_TRIGGERHAPPY_POST_INSTALL_TARGET_HOOKS += BATOCERA_TRIGGERHAPPY_INSTALL_RG35XX_PLUS_CONFIG
endif
