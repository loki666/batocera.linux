...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_RG35XX_PLUS),y)
  BATOCERA_SCRIPT_RESOLUTION_TYPE=rg35xx_plus
  BATOCERA_SCRIPT_SCREENSHOT_TYPE=drm
endif
...
define BATOCERA_RESOLUTION_INSTALL_RG35XX_PLUS
        install -m 0755 $(BATOCERA_RESOLUTION_PATH)/resolution/batocera-resolution-post-rg35xx_plus $(TARGET_DIR)/usr/bin/batocera-resolution-post
endef
...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_RG35XX_PLUS),y)
  BATOCERA_RESOLUTION_POST_INSTALL_TARGET_HOOKS += BATOCERA_RESOLUTION_INSTALL_RG35XX_PLUS
endif
