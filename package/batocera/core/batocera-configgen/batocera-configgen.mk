...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_BCM2835),y)
	...
	BATOCERA_CONFIGGEN_SYSTEM=rg35xx_plus
...
define BATOCERA_CONFIGGEN_RG35XX_PLUS_HOOKS
	install -D -m 0755 $(CONFIGGEN_DIR)/scripts/rg35xx_plus_powermode_launch_hooks.sh \
		$(TARGET_DIR)/usr/share/batocera/configgen/scripts/rg35xx_plus_powermode_launch_hooks.sh
endef
...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_RG35XX_PLUS),y)
	BATOCERA_CONFIGGEN_POST_INSTALL_TARGET_HOOKS += BATOCERA_CONFIGGEN_RG35XX_PLUS_HOOKS
endif
